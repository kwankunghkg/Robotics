...
LEDMatrixDriver led(LEDMATRIX_SEGMENTS, LEDMATRIX_CS_PIN); // , LEDMatrixDriver::INVERT_SEGMENT_X );
 ...
 */
const uint16_t SCROLL_DELAY = 150;
 ...
 */
char text_demo[] = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'abcdefghijklmnopqrstuvwxyz{|}~";
