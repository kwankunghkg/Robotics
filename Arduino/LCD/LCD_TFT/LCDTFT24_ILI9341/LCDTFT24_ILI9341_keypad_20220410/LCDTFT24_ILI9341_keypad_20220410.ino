...
//int32_t BRIGHTBLUE  = 0b00111_001111_11111 ;
#define BRIGHTBLUE  0b0011100111111111
...
//int32_t GREY        = 0b01000_010000_01000;
#define GREY        0b0100001000001000
#define GOLD        0xFEA0
#define BROWN       0xA145
...
#define Y1 A1  // need two analog inputs
#define X1 A2  // 
#define Y2  7  // 
#define X2  6  //
...
uint16_t ROW_L=890; // TS last row
uint16_t COL_F= 75; // TS first column
uint16_t COL_L=890; // TS last column
...
// * /
  ...
  LCD_rect(T_COL+10,T_ROW-10, 6, 6, F_COLOR);  
