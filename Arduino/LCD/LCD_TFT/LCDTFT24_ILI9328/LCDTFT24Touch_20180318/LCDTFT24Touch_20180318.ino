...
#define TS_MINX 230 // 150
#define TS_MINY 180 // 120
#define TS_MAXX 900 // 920
#define TS_MAXY 940
...
#define BOXSIZE 40
#define PENRADIUS 3
int oldcolor=RED, currentcolor=RED;
...
//    }
    ...
    */
    if (p.y < BOXSIZE) {
       ...
       if (p.x < BOXSIZE) { 
         currentcolor = RED; 
         tft.drawRect(BOXSIZE*0, 0, BOXSIZE, BOXSIZE, WHITE);
    ...
    //Serial.print("\tC="); Serial.print(currentcolor);
    //Serial.println("");
